...
**说明**：对于现在才开始学习的同学是选择学习Python2 还是学习Python3，请参考白月黑羽的另外一篇文章[是选择学习 Python2 还是 Python 3？](http://www.python3.vip/doc/blog/python/2019011401/)了解
...
-----
可能有的同学会问，Python3.7可以降到Python3.6吗？考虑到Python安装简单，白月黑羽一般建议你直接卸载，然后到官方下载和你系统对应的Python3.6版本（主要区分32位和64位即可）安装，可参考白月黑羽教程中-[Python解释器安装](http://www.python3.vip/doc/tutorial/python/0001/#python解释器)，有视频带你一步一步安装。
