...
---
```白月黑羽教Python学习视频``` - 字典的使用2

<video src="https://github.com/baiyueheiyu/v/raw/master/py/p17_3.mp4"  style="width: 90%;" controls controlsList="nodownload" oncontextmenu="return false;" preload="metadata"></video>
