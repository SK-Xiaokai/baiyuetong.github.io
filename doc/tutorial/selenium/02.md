...
![default](https://user-images.githubusercontent.com/36257654/38093280-0935e954-339d-11e8-882a-8fb3dd534d81.png)

<br>

然后，再点击 最左边的图标，如下所示

![default](https://user-images.githubusercontent.com/36257654/38093410-73d3966c-339d-11e8-9d6d-ade673f51d76.png)
...
![default](https://user-images.githubusercontent.com/36257654/38093785-8c917100-339e-11e8-8cd6-3ccebbe20407.png)
...
下面的代码，就是用selenium 访问百度，并且在输入框中搜索 ```白月黑羽``` 。
...
就是使用 WebDriver 对象 的方法 find_element_by_id， 这个方法就是 根据输入框元素的 id 值 'kw' 来选择到元素。 

选择到元素之后， find_element_by_id 方法会 **返回一个 WebElement 类型的对象**， 这个对象就代表了 选择的界面元素。

我们通过这个WebElement对象，就可以操控对应的界面元素。

比如 调用这个对象的 send_keys 方法就是在对应的元素中 输入字符串， 

而 调用这个对象的 click 方法就可以 **点击** 该元素。
...
大家请访问这个网址 
http://www.python3.vip/doc/tutorial/python/code/sample1.html
...
![default](https://user-images.githubusercontent.com/36257654/38163256-b8ca567a-3523-11e8-9ec7-ce4a667c76ad.png)
